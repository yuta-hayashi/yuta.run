    ...
    <div id="sections">
      <section>
        ...
        <p class="top_p">
          ...
          同じアプリケーションを動作させることができるのです。<br />
          高機能なブラウザと高度に発展したJavascriptとライブラリにより、
          ネイティブアプリケーションに劣らない体験を実現できるようになりました。<br />
          Webの可能性をさらに広げる、ということを私は目指しています。
        </p>
      </section>
      <section>
        <h2>Works</h2>
...
export default {
  ...
  mounted() {
    if (this.fullName != "") setInterval(this.addName, 90);
  },
  methods: {
    addName() {
